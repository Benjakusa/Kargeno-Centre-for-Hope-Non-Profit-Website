document.addEventListener('DOMContentLoaded', () => {
    ...
    // Card Animations
    const cards = document.querySelectorAll('.activity-card, .impact-card');
    ...
    // Section Animations
    const sections = document.querySelectorAll('.hero-section, .about-section, .activities-section, .impact-section, .get-involved-section');
